  ...
  return (
    <div>
      ...
      <div ref={printRef} className="invoice-print" style={{ position: 'relative' }}>
        ...
        {/* Hidden ownership signature - invisible but present in DOM/PDF */}
        <div style={{ position: 'absolute', left: '-9999px', fontSize: '1px', color: 'transparent', userSelect: 'none' }} aria-hidden="true">
          {_watermark} Generated by Invoice Creator - Copyright 2025 Blue Line Scannables - BLS-IC-7X9K2M4P
        </div>
      </div>
    </div>
  );
